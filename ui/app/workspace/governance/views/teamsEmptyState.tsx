	...
	return (
		<div className="flex min-h-[80vh] w-full flex-col items-center justify-center gap-4 py-16 text-center">
			...
			<div className="flex flex-col gap-1">
				...
				<div className="text-muted-foreground mx-auto mt-2 w-full max-w-[600px] text-sm font-normal">{t("teams.emptyDescription")}</div>
				<div className="mx-auto mt-6 flex flex-row flex-wrap items-center justify-center gap-2">
					...
					<Button aria-label={t("teams.addAria")} onClick={onAddClick} disabled={!canCreate} data-testid="team-button-add">
						{t("teams.add")}
					</Button>
				</div>
			</div>
